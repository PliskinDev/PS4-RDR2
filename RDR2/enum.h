...
enum class eInput : uint32_t
{
	...
	INPUT_TAKE_GENERIC = 0x55A2C413,
	INPUT_CLAIM_GENERIC = 0xDF8FE9C5,
	INPUT_STEAL_GENERIC = 0x46C4F376,
	INPUT_BUY_GENERIC = 0x72052664
};
...
enum class eInputGroup
{
	...
	INPUTGROUP_FRONTEND_NAV_ALL = 9,
	INPUTGROUP_FRONTEND_NAV_UD = 10,
	INPUTGROUP_FRONTEND_NAV_LR = 11,
	INPUTGROUP_FRONTEND_LSTICK_ALL = 12,
	INPUTGROUP_FRONTEND_RSTICK_ALL = 13,
	INPUTGROUP_FRONTEND_GENERIC_UD = 14,
	INPUTGROUP_FRONTEND_GENERIC_LR = 15,
	INPUTGROUP_FRONTEND_GENERIC_ALL = 16,
	INPUTGROUP_FRONTEND_BUMPERS = 17,
	INPUTGROUP_FRONTEND_TRIGGERS = 18,
	INPUTGROUP_FRONTEND_STICKS = 19,
	INPUTGROUP_SCRIPT_DPAD_ALL = 20,
	INPUTGROUP_SCRIPT_DPAD_UD = 21,
	INPUTGROUP_SCRIPT_DPAD_LR = 22,
	INPUTGROUP_SCRIPT_LSTICK_ALL = 23,
	INPUTGROUP_SCRIPT_RSTICK_ALL = 24,
	INPUTGROUP_SCRIPT_BUMPERS = 25,
	INPUTGROUP_SCRIPT_TRIGGERS = 26,
	INPUTGROUP_RADIAL_MENU_NAV_CYCLE = 27,
	INPUTGROUP_FLY = 28,
	INPUTGROUP_SUB = 29,
	INPUTGROUP_VEH_MOVE_ALL = 30,
	INPUTGROUP_CURSOR = 31,
	INPUTGROUP_CURSOR_SCROLL = 32,
	INPUTGROUP_SNIPER_ZOOM_SECONDARY = 33,
	INPUTGROUP_HORSE_MOVE = 34,
	INPUTGROUP_GAME_MENU_ALL = 35,
	INPUTGROUP_GAME_MENU_LR = 36,
	INPUTGROUP_GAME_MENU_UD = 37,
	INPUTGROUP_GAME_MENU_TAB_LR = 38,
	INPUTGROUP_GAME_MENU_TAB_LR_SECONDARY = 39,
	INPUTGROUP_GAME_MENU_SCROLL = 40,
	INPUTGROUP_DOCUMENT_PAGE_LR = 41,
	INPUTGROUP_SATCHEL_ALL = 42,
	INPUTGROUP_SATCHEL_UD = 43,
	INPUTGROUP_SATCHEL_LR = 44,
	INPUTGROUP_MINIGAME_FISHING_REEL = 45,
	INPUTGROUP_MINIGAME_FISHING_LSTICK_ALL = 46,
	INPUTGROUP_MINIGAME_FISHING_RSTICK_ALL = 47,
	INPUTGROUP_GAME_MENU_RSTICK_ALL = 48,
	INPUTGROUP_GAME_MENU_LSTICK_ALL = 49,
	INPUTGROUP_MINIGAME_DOMINOES_MOVE_LR = 50,
	INPUTGROUP_MINIGAME_DOMINOES_MOVE_UD = 51,
	INPUTGROUP_MINIGAME_DOMINOES_MOVE_ALL = 52,
	INPUTGROUP_CAMERA_ADVANCED_ZOOM = 53,
	INPUTGROUP_INVALID = 54
};
...
enum class eKey
{
	...
	KEY_RAGE_EXTRA4 = 131,
	KEY_NUMPADENTER = 132,
	KEY_CHATPAD_GREEN_SHIFT = 133,
	KEY_CHATPAD_ORANGE_SHIFT = 134,
	KEY_NULL = 135
};

enum class eWeapon : uint32_t
{
	...
	WEAPON_BOW_IMPROVED_MP = 0xE8BE49CF,
