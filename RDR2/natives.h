...
{
	static Entity _0x53E4D0C079CA6855(ScrHandle handle) { return invoke<Entity>(0x0213D6E0, handle); } // 0x53E4D0C079CA6855 b1207
	static BOOL _DOES_COVER_POINT_EXIST(ScrHandle handle) { return invoke<BOOL>(0x0213D700, handle); } // 0xC276FE69DDA22BAD b1207
	...
	static void _0xEBA51A294C73292E(Any* args) { invoke<Void>(0x0213DD20, args); } // 0xEBA51A294C73292E b1207
...
namespace SOCIALCLUB
{
	...
	static BOOL SC_INBOX_MESSAGE_GET_DATA_STRING(int p0, const char* context, const char* out) { return invoke<BOOL>(0x026039B0, p0, context, out); } // 0x66F77FD58506FF6B 0x15607620 b1207
	...
	static BOOL SC_COMMUNITY_EVENT_IS_ACTIVE() { return invoke<BOOL>(0x02603D40); } // 0xCBF743C984695CF3 0xC96456BA b1207
	static int SC_COMMUNITY_EVENT_GET_EVENT_ID() { return invoke<int>(0x02603EA0); } // 0xD635DF6BAA5A6017 0xC5E08B66 b1207
	static BOOL SC_COMMUNITY_EVENT_GET_EXTRA_DATA_INT(const char* p0, int* p1) { return invoke<BOOL>(0x02603FF0, p0, p1); } // 0xB4411D4D6B81438E 0x04EE74A3 b1207
	static BOOL SC_COMMUNITY_EVENT_GET_EXTRA_DATA_FLOAT(const char* p0, float* p1) { return invoke<BOOL>(0x02604230, p0, p1); } // 0x060BBAD634C2B44B 0x8DA93C3D b1207
	static BOOL SC_COMMUNITY_EVENT_GET_EXTRA_DATA_STRING(const char* p0, const char* p1) { return invoke<BOOL>(0x02604470, p0, p1); } // 0x9F6DCD0C939C71E9 0x37DD48B5 b1207
	static BOOL SC_COMMUNITY_EVENT_GET_DISPLAY_NAME(const char* p0) { return invoke<BOOL>(0x02604680, p0); } // 0x89D9BDE7334B110F 0xF929F61D b1207
	static BOOL SC_COMMUNITY_EVENT_IS_ACTIVE_FOR_TYPE(const char* p0) { return invoke<BOOL>(0x02604820, p0); } // 0x09937EB0CEBC2F9F 0x0572EB5E b1207
	static int SC_COMMUNITY_EVENT_GET_EVENT_ID_FOR_TYPE(const char* p0) { return invoke<int>(0x02604960, p0); } // 0x03C03ABBABBEF752 0x8E7AEEB7 b1207
	static BOOL SC_COMMUNITY_EVENT_GET_EXTRA_DATA_INT_FOR_TYPE(const char* p0, int* p1, const char* p2) { return invoke<BOOL>(0x02604AB0, p0, p1, p2); } // 0x3519CC3525319A96 0x28C57FA0 b1207
	static BOOL SC_COMMUNITY_EVENT_GET_EXTRA_DATA_FLOAT_FOR_TYPE(const char* p0, float* p1, const char* p2) { return invoke<BOOL>(0x02604CE0, p0, p1, p2); } // 0x1BDB56DB258F052D 0x59394583 b1207
	static BOOL SC_COMMUNITY_EVENT_GET_EXTRA_DATA_STRING_FOR_TYPE(const char* p0, const char* p1, const char* p2) { return invoke<BOOL>(0x02604F10, p0, p1, p2); } // 0xC8FC3B2432E8229D 0x92452C0E b1207
	static BOOL SC_COMMUNITY_EVENT_GET_DISPLAY_NAME_FOR_TYPE(const char* p0, const char* p1) { return invoke<BOOL>(0x02605100, p0, p1); } // 0x85EA0BEC7B1F7622 0xBBA8D34D b1207
	static BOOL SC_COMMUNITY_EVENT_IS_ACTIVE_BY_ID(int p0) { return invoke<BOOL>(0x02605290, p0); } // 0x62B384FEFDE06817 0xB21288FA b1207
	static BOOL SC_COMMUNITY_EVENT_GET_EXTRA_DATA_INT_BY_ID(int p0, const char* p1, int* p2) { return invoke<BOOL>(0x02605400, p0, p1, p2); } // 0x7C981DE05A7403A0 0xE778B2A7 b1207
	static BOOL SC_COMMUNITY_EVENT_GET_EXTRA_DATA_FLOAT_BY_ID(int p0, const char* p1, float* p2) { return invoke<BOOL>(0x02605550, p0, p1, p2); } // 0x91C9E2A0F9DD6DD4 0x7E24BD6E b1207
	static BOOL SC_COMMUNITY_EVENT_GET_EXTRA_DATA_STRING_BY_ID(int p0, const char* p1, const char* p2) { return invoke<BOOL>(0x026056A0, p0, p1, p2); } // 0x049D2196D9D11184 0xCE7D50A8 b1207
	static BOOL SC_COMMUNITY_EVENT_GET_DISPLAY_NAME_BY_ID(int p0, const char* p1) { return invoke<BOOL>(0x02605800, p0, p1); } // 0x11EA52CAD1B55910 0xD26CCA46 b1207
}
